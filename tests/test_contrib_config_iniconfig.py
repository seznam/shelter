...
def test_config_interfaces(test_conf_dir):
    ...
    assert interfaces[1].api_doc == {'enabled': True}
    assert interfaces[1].processes == 16
    assert interfaces[1].start_timeout == 60.0
    ...
    assert interfaces[2].api_doc == {'enabled': True, 'version': '0.0.1'}
    ...
    assert interfaces[3].api_doc == {}
    assert interfaces[3].processes == 8
